    ...
    <>
      <div className='row text-white py-3 shadow'>
        <div className='col-8 text-align-left d-flex align-content-start px-5'>
          <Link className="navbar-brand fs-1 fw-bold" to="/" style={{color:"#FF6700"}}>Burger House</Link>
        ...
        <div className='col-4 d-flex justify-content-end'>
          ...
          }
          {
            ...
            <>
              ...
              <Link to='/bag'><i className="bi bi-cart fs-3 me-3" style={{color:"#FF6700"}}></i></Link>
            </>
          }
          {
            user && user.role === 1 &&
